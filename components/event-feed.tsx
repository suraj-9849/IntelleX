...
export function EventFeed({
  ...
  const [selectedEventForAlert, setSelectedEventForAlert] = useState<
    string | null
  >(null);
  ...
  return (
    <div className='relative flex flex-col space-y-4'>
      <h2 className='text-2xl font-bold tracking-tight text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.7)]'>
        Recent Incidents
      </h2>
      <AnimatePresence>
      ...
      <SecurityAlertModal
        ...
        onOpenChange={(open: boolean) =>
          !open && setSelectedEventForAlert(null)
        }
        onAlertComplete={() => {
