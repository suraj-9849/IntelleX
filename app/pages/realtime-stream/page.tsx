...
import { StopCircle, PlayCircle, Save, Loader2 } from 'lucide-react';
      ...
      try {
        ...
        predictions.forEach((prediction: blazeface.NormalizedFace) => {
          ...
          const confidence = Math.round(
            (prediction.probability as number) * 100
          );
          ctx.fillStyle = 'white';
          ctx.font = '16px Arial';
  ...
  return (
    <div className='flex min-h-screen items-center justify-center bg-black p-4 text-white'>
      <div className='relative w-full max-w-4xl'>
        <div className='absolute inset-0 rounded-full bg-purple-900/5 blur-3xl'></div>
        <div className='relative z-10 p-8'>
          <div className='space-y-8'>
            <div className='text-center'>
              <h1 className='mb-2 text-3xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.7)]'>
            ...
            <div className='space-y-4'>
              ...
              <div className='flex justify-center gap-4'>
                {isInitializing ? (
                  <button
                    disabled
                    className='flex cursor-not-allowed items-center gap-2 rounded-lg bg-zinc-600 px-4 py-2 transition-colors'
                  >
                  ...
                  <button
                    ...
                    className='flex items-center gap-2 rounded-lg bg-green-600 px-4 py-2 transition-colors hover:bg-green-700'
                  >
